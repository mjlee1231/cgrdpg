% Aggregate one-step Jacobi cgrdpg coverage results from 100 replications
clear; clc;

fprintf('Aggregating 3D One-Step Jacobi cgrdpg Coverage Results\n');
fprintf('=======================================================\n\n');
...
save(fullfile(results_dir, 'aggregated_one_step_results.mat'), ...
    ...
    'all_sse_ase', 'all_sse_one_step_jacobi', ...
    'all_times_ase', 'all_times_one_step_jacobi', ...
