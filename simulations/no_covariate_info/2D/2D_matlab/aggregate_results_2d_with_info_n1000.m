% Aggregate results for 2D WITH COVARIATE INFO simulation (n=1000, p_cov=500)
clear; clc;

fprintf('Aggregating 2D WITH COVARIATE INFO Results (n=1000, p_cov=500)\n');
fprintf('============================================================\n\n');

results_dir = 'results_2d_with_info_n1000';
n_reps = 100;
n_vertices = 1000;
...
%% Summary
fprintf('========================================\n');
fprintf('Coverage Summary (2D WITH COVARIATE INFO)\n');
fprintf('========================================\n\n');
