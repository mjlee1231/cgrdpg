...
if (length(args) != 1) {
  stop("Usage: Rscript vertex_wise_coverage_1d_have_info_n500.R <rep_id>")
}
...
cat("============================================================================\n")
cat(sprintf("  1D SIMULATION WITH COVARIATE INFO - REPLICATION %d/100\n", rep_id))
cat("  Z0 = rnorm (covariates contain signal)\n")
...
# Save result
output_dir <- "results_1d_have_info_n500"
