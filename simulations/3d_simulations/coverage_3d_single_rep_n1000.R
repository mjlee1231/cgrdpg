#!/usr/bin/env Rscript
# coverage_3d_single_rep_n1000.R
# Single replication for 3D GRDPG coverage using R package (n=1000, p_cov=500)
...
if (length(args) == 0) stop("Usage: Rscript coverage_3d_single_rep_n1000.R <rep_number>")
...
output_dir <- "results_r_3d_coverage_n1000"
if (!dir.exists(output_dir)) dir.create(output_dir, recursive = TRUE)

cat("============================================================================\n")
cat("  cgrdpg Coverage Simulation (R): n=1000, p_cov=500\n")
