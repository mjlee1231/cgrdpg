...
set.seed(589 + rep_id)  # Seeds starting at 589
...
# Using optimized configuration: r=0.28, c=0.42
theta <- pi * (1:n) / (n-1)
...
cat("Computing vertex-wise coverage for all 500 vertices...\n")
...
output_dir <- "ase_ose_results_n500"
...
output_file <- file.path(output_dir, sprintf("ase_ose_rep%03d.rds", rep_id))
