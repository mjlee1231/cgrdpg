#!/usr/bin/env Rscript
# ASE vs OSE vs cgrdpg vertex-wise coverage: 3D GRDPG, n=2000, 100 reps
...
# Signature matrix: S = diag(1, 1, -1), p_cov=1000

library(cgrdpg)

# --- Parameters ---
args <- commandArgs(trailingOnly = TRUE)
if (length(args) == 0) stop("Usage: Rscript ase_ose_vertex_wise_3d_n2000.R <rep_number>")
...
output_dir <- "results_3d_ase_ose_cgrdpg_n2000"
if (!dir.exists(output_dir)) dir.create(output_dir, recursive = TRUE)

cat("============================================================================\n")
cat("  ASE vs OSE vs cgrdpg Vertex-wise Coverage: 3D GRDPG, n=2000\n")
cat(sprintf("  Replication %d/100\n", rep_id))
cat("  Methods: cgrdpg-TRUE, cgrdpg-PLUGIN, ASE-TRUE, ASE-PLUGIN, OSE-TRUE, OSE-PLUGIN\n")
cat("  S = diag(1, 1, -1), p_cov=1000\n")
cat("============================================================================\n\n")
