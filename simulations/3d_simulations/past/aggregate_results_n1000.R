#!/usr/bin/env Rscript
# Aggregate vertex-wise coverage results for 3D GRDPG: n=1000

library(ggplot2)
library(dplyr)

cat("============================================================================\n")
cat("  AGGREGATING VERTEX-WISE COVERAGE RESULTS: 3D GRDPG, n=1000\n")
cat("============================================================================\n\n")

# Load all results
results_dir <- "results_3d_n1000"
...
saveRDS(aggregated, "aggregated_results_3d_n1000.rds")
cat("Aggregated results saved to: aggregated_results_3d_n1000.rds\n\n")
...
write.csv(summary_df, "summary_3d_n1000.csv", row.names = FALSE)
cat("Summary saved to: summary_3d_n1000.csv\n\n")

# Plot coverage distributions
cat("Creating plots...\n")

# 1. Boxplot of coverage rates
pdf("coverage_boxplot_3d_n1000.pdf", width = 8, height = 6)
...
pdf("vertex_coverage_3d_n1000.pdf", width = 10, height = 6)
...
cat("Plots saved:\n")
cat("  - coverage_boxplot_3d_n1000.pdf\n")
cat("  - vertex_coverage_3d_n1000.pdf\n")
