...
if (length(args) == 0) stop("Usage: Rscript vertex_wise_coverage_2d_have_info_n1000.R <rep_number>")
...
output_dir <- "results_2d_have_info_n1000"
if (!dir.exists(output_dir)) dir.create(output_dir, recursive = TRUE)

cat("============================================================================\n")
cat("  Vertex-wise Coverage: WITH COVARIATE INFORMATION (n=1000)\n")
