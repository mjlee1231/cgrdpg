#!/usr/bin/env Rscript
# ASE vs OSE vertex-wise coverage simulation: n=1000
...
for (i in 1:n) {
  if (i %% 200 == 0) cat(sprintf("  Vertex %d/%d (%.1f%%)\n", i, n, 100*i/n))
...
output_dir <- "ase_ose_results_n1000"
...
output_file <- file.path(output_dir, sprintf("ase_ose_n1000_rep%03d.rds", rep_id))
