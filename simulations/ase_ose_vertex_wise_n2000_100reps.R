#!/usr/bin/env Rscript
# ASE vs OSE vertex-wise coverage simulation: n=2000
...
for (i in 1:n) {
  if (i %% 400 == 0) cat(sprintf("  Vertex %d/%d (%.1f%%)\n", i, n, 100*i/n))
...
output_dir <- "ase_ose_results_n2000"
...
output_file <- file.path(output_dir, sprintf("ase_ose_n2000_rep%03d.rds", rep_id))
