% Visualize ASE empirical vs theoretical distribution for MULTIPLE vertices
% Creates diagnostic plots for several vertices to check coverage behavior
clear; clc;
addpath('core');

fprintf('Visualizing ASE Vertex Distribution: Multiple Vertices\n');
fprintf('======================================================\n\n');
...
% [~, idx_low] = mink(agg.vertexwise_coverage_ase_plugin, 3);   % Lowest coverage
% [~, idx_high] = maxk(agg.vertexwise_coverage_ase_plugin, 3);  % Highest coverage
