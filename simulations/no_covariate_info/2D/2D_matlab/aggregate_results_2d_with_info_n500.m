% Aggregate results for 2D WITH COVARIATE INFO simulation (n=500, p_cov=250)
clear; clc;

fprintf('Aggregating 2D WITH COVARIATE INFO Results (n=500, p_cov=250)\n');
fprintf('============================================================\n\n');

results_dir = 'results_2d_with_info_n500';
n_reps = 100;
n_vertices = 500;
