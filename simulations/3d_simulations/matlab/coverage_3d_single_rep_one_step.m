...
% COVERAGE_3D_SINGLE_REP_ONE_STEP Test one-step Jacobi cgrdpg estimator
%
% Compares:
%   - ASE (baseline)
%   - cgrdpg-ONE-STEP-JACOBI: Single Newton step, updates computed in parallel and applied at once
%
% Inputs:
...
fprintf('============================================================================\n');
fprintf('  One-Step Jacobi cgrdpg Estimator: 3D GRDPG, n=%d\n', n);
fprintf('  Replication %d/100\n', rep_id);
fprintf('  Methods: ASE, cgrdpg-ONE-STEP-JACOBI\n');
...
%% 6. Vertex-wise coverage (ASE and Jacobi with TRUE and PLUGIN)
...
save(out_file, ...
    ...
    'sse_ase', 'sse_one_step_jacobi', ...
    'ase_time', 'one_step_jacobi_time', ...
