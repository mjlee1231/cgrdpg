# Diagnostic: 2D SPREAD latent positions with Manual Oracle Procrustes Alignment
...
output_file <- sprintf("simulations/diagnostic_2d_spread_oracle_rep%d.rds", rep_to_run)
