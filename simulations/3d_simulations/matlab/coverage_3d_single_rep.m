function coverage_3d_single_rep(rep_id)
% COVERAGE_3D_SINGLE_REP Compute vertex-wise coverage for 3D GRDPG
%
...
% Output directory
output_dir = 'results_matlab_3d_coverage';
...
% Fisher scoring was numerically unstable without proper line search
