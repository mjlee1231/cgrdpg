#!/usr/bin/env Rscript
# Compute vertex-wise coverage across replications for ASE vs OSE (n=1000)
# For each vertex i: what is its coverage rate across 100 replications?

cat("============================================================================\n")
cat("  VERTEX-WISE COVERAGE ACROSS REPLICATIONS: ASE vs OSE (n=1000)\n")
cat("  Computing coverage for each vertex across 100 replications\n")
cat("============================================================================\n\n")

results_dir <- "ase_ose_results_n1000"
...
result_files <- list.files(results_dir, pattern = "ase_ose_n1000_rep\\d{3}\\.rds", full.names = TRUE)
...
saveRDS(vertexwise_results, "vertexwise_coverage_ase_ose_n1000.rds")
cat("Vertex-wise coverage saved to: vertexwise_coverage_ase_ose_n1000.rds\n")
...
write.csv(df, "vertexwise_coverage_ase_ose_n1000.csv", row.names = FALSE)
cat("Vertex-wise coverage CSV saved to: vertexwise_coverage_ase_ose_n1000.csv\n")
