#!/usr/bin/env Rscript
# Aggregate R coverage results from 100 replications (n=2000, p_cov=1000)

cat("Aggregating 3D cgrdpg Coverage Results (R package, n=2000)\n")
cat("==========================================================\n\n")

results_dir <- "results_r_3d_coverage_n2000"
n_reps <- 100
n_vertices <- 2000
