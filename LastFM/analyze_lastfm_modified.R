...
cat("============================================================================\n")
cat("  LASTFM ANALYSIS: MODIFIED FISHER-SCORING (maxit=10)\n")
...
saveRDS(ase_ose_results, "lastfm_modified_ase_ose_results.rds")
cat(sprintf("\n✓ ASE/OSE results saved to: lastfm_modified_ase_ose_results.rds\n"))
...
cat(sprintf("Estimated time: ~2-4 hours\n\n"))
...
saveRDS(complete_results, "lastfm_modified_complete_results.rds")
...
cat("\nResults saved:\n")
cat("  - lastfm_modified_ase_ose_results.rds (early save)\n")
cat("  - lastfm_modified_complete_results.rds (final with Fisher)\n")
cat("============================================================================\n")
