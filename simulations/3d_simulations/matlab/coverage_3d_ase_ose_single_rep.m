function coverage_3d_ase_ose_single_rep(rep_id)
% COVERAGE_3D_ASE_OSE_SINGLE_REP Compare ASE/OSE/cgrdpg vertex-wise coverage (3D)
%
% Single replication - same structure as coverage_3d_single_rep.m
...
output_dir = 'results_matlab_3d_ase_ose_cgrdpg';
if ~exist(output_dir, 'dir')
    mkdir(output_dir);
end

fprintf('============================================================================\n');
fprintf('  ASE vs OSE vs cgrdpg Vertex-wise Coverage: 3D GRDPG, n=%d\n', n);
...
%% 1. Generate data (SAME as cgrdpg simulation)
t = (1:n)' / n;
...
% Overall coverage rates (for this single rep)
overall_cov = struct();
