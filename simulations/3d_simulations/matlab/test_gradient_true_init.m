% Test gradient correctness using TRUE initialization (not ASE)
% This isolates gradient calculation from ASE initialization issues
clear; clc;

% Add core folder to path
addpath('core');

fprintf('Testing Gradient with TRUE Initialization\n');
fprintf('========================================\n\n');
...
for size_idx = 1:length(test_sizes)
    ...
    % USE TRUE VALUES instead of ASE
    fprintf('Using TRUE initialization (not ASE)\n');
    X_init = X_true;
    S_estimated = S;
...
%% Summary
fprintf('========================================\n');
fprintf('Summary Across All Sizes (TRUE init)\n');
fprintf('========================================\n\n');
