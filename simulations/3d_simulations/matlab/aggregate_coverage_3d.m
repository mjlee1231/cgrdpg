% Aggregate coverage results from 100 replications - VERTEX-WISE (3D)
clear; clc;

fprintf('Aggregating 3D Coverage Results (Vertex-wise)\n');
fprintf('========================================\n\n');

results_dir = 'results_matlab_3d_coverage';
n_reps = 100;
n_vertices = 1000;  % From simulation parameters
