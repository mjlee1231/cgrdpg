...
% Compares:
%   - ASE (baseline)
%   - cgrdpg-ONE-STEP-BATCH: Fix Y_hat, Z_hat, optimize X with fminunc (~16% improvement)
%   - cgrdpg-ONE-STEP-JACOBI: Single Newton step (~9% improvement)
%
% Inputs:
...
%% 4. cgrdpg-ONE-STEP-BATCH (fminunc)
